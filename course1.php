...
<html>
		<head>
		    ...
		    <link href="https://fonts.googleapis.com/css?family=Cookie|Courgette|Lobster|Playfair+Display|Satisfy" rel="stylesheet">
		    <!--  font awesome here -->
                    ...
                    <nav id="mainNav" class="navbar navbar-fixed-top no-margin" >
						        <div class="container">
						            <div class="navbar-header size">    
						                <a class="navbar-brand" href="courses.html"><i class="fa fa-arrow-left"></i>  Details</a>
						            </div>  
						      </div>
			           </nav>
			           <!-- header background image here -->
			           <div class="container-fluid bgImage no-margin">
			                	<h1 class="text-center name1"></h1>	
			                    	...
			                    	<div class="row col-md-offset-1">
			                    	     ...
			                    	     <div class="col-md-4 col-sm-4 col-xs-12 text-center">
			                    	 	       <h4>main Directors</h4>
			                    	 	  	   ...
			                    	 	  	   <li><a class="link" target="_blank" href="www.facebook.com"><img src="images/facebook.png" class="col-md-4 col-xs-4 col-xs-offset-4"></a></li>  
			                    	     </div>
			                    	 </div>    
			                    </div>      
			           </footer>
